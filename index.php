...
<head>
  ...
  <meta content="" name="Author: MH RONY">
  <meta content="" name="Youtube Channel Name: Code Camp BD">
  <!--  Author Name: MH RONY.
        GigHub Link: https://github.com/dev-mhrony
        Facebook Link:https://www.facebook.com/dev.mhrony
        Youtube Link: https://www.youtube.com/channel/UChYhUxkwDNialcxj-OFRcDw
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Student Grading System - CCBD</h3>
            <p>Sonatola,<br>
              Bogura, Bangladesh<br><br>
              <strong>Phone:</strong> +8801608445456,<br>
              <strong>Email:</strong> developer.mhrony@gmail.com<br>
            </p>
          </div>
            <!-- =======================================================
              * Project Name: Student Gaide - CCBD
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
            &copy; <?php echo date('Y')?> Student Grading System - Copyright by <a href="https://www.youtube.com/@codecampbdofficial"> Code Camp BD </a> Developer - <a href="https://www.facebook.com/dev.mhrony" target="_blank" > MH RONY </a>
        </div>
        <div class="credits">
            <!-- =======================================================
              * Project Name: Student Gaide - CCBD
